...
type DisjointSubsetsTests() = 
    ...
    [<Test>]
    member this.disjoint_subsets_of_1_1_1_items_returns_expected_output() =         
        DisjointSubsets.group [1;1;1] ["Al"; "Bae"; "Cal"]
    ...
    [<Test>]
    member this.disjoint_subsets_of_1_1_1_1_items_returns_expected_output() =         
        DisjointSubsets.group [1;1;1;1] ["Al"; "Bae"; "Cal"; "Dee"]
        |> sortDisjointSubsetsList
        |> should equal 
                (sortDisjointSubsetsList 
                [[["Al"]; ["Bae"]; ["Cal"]; ["Dee"]]; 
